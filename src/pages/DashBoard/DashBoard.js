...
//         <li><Link to="/ShowShops">Show Shops</Link></li>
//         <li><Link to="/AddShop">Add Shops</Link></li>
//         <li><Link to="/ProductDisplay">Product Display</Link></li>
//         <li><Link to="/ShopProducts">Shop Products</Link></li>
//         <li><Link to="/SearchShops">Search Shops</Link></li>
//         <li><Link to="/AddShop">Add Shops</Link></li>
...
{/* <nav class="bg-white border-gray-200 dark:bg-gray-900">
 ...
 <Navbar expand="lg" className="bg-body-tertiary">
      <Container fluid>
        <Navbar.Brand href="/">StriX</Navbar.Brand>
        ...
        <Navbar.Collapse id="navbarScroll">
          <Nav
            ...
            navbarScroll
          >
            <Nav.Link href="/ShowShops">Show Business</Nav.Link>
            <Nav.Link href="/Login">Login</Nav.Link>
            <NavDropdown title="My Shop" id="navbarScrollingDropdown">
              <NavDropdown.Item href="/AddShop">Add Product</NavDropdown.Item>
              <NavDropdown.Item href="/AddProduct">
                Add Products
              </NavDropdown.Item>
              <NavDropdown.Divider />
              <NavDropdown.Item href="/ProductDisplay">
                My Products
              </NavDropdown.Item>
            </NavDropdown>
          ...
          <Form className="d-flex">
            <Form.Control
              ...
              aria-label="Search"
            />
            <Button variant="outline-success" href='/ShowShops'>Search</Button>
          </Form>
        </Navbar.Collapse>
      </Container>
    </Navbar> 
